<template>
  <div class="body-box">
    ...
    <!-- <div class="steps" :style="{width:btnName==='CONFIRM'?'67%':'100%'}"></div> -->
    <div class="body-mian">
      <div class="main-l" v-if="btnName==='CONFIRM'">
        <p v-if="allow===0">You need to agree to allow linking your wallet.</p>
        <p
          v-else
        >Select the size and IR you want to bid over a {{this.name[this.$route.query.code-1]}} period.</p>
      ...
      <div class="main-l" v-else>
        <p>
          ...
          >{{list[this.calssNum].ratio}}</span> in
          <span style="border-bottom:none;font-family: 'Bold';">{{money}} yyCRV</span>
          for the {{this.name[this.$route.query.code-1]}} market.
        </p>
